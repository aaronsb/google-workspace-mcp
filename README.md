...
Those 80 operations reach 60 of the 233 methods Google publishes across these seven APIs. The rest is mapped, not guessed — see **[API coverage](docs/coverage.md)**, which is generated by diffing the manifest against Google's live Discovery documents.
